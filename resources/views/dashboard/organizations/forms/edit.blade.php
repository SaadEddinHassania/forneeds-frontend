            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group col-sm-6 {{ $errors->has('company_id') ? 'has-error' : ''}}">
                        ...
                        {{ Form::select('sp[company_id]', $companies,array_keys($sp->company()->pluck('name','id')->toArray()),['class'=>'selectpicker show-tick show-menu-arrow form-control','data-style'=>"btn-default"]) }}
                    </div>
