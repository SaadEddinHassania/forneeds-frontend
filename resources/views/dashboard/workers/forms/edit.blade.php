        ...
        <div class="page-content" style="background-color:#fff">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <a href="index.html">Social Workers</a>
            ...
            <div class="row">
                ...
                <!-- Name Field -->
                    ...
                    <!-- age Id Field -->
                    <div class="form-group col-sm-6">
                        {!! Form::label('age_id', 'Area:') !!}
                        {!! Form::select('age_id',$ages ,null, ['data-style'=>'btn-default','placeholder'=>'please select age','class' => 'selectpicker show-tick show-menu-arrow form-control']) !!}
                    </div>
                    <!-- gender Id Field -->
                    <div class="form-group col-sm-6">
                        {!! Form::label('gender_id', 'Gender:') !!}
                        {!! Form::select('gender_id',  $genders ,null, ['data-style'=>'btn-default','placeholder'=>'please select gender','class' => 'selectpicker show-tick show-menu-arrow form-control']) !!}
                    </div>
