            ...
            <div class="row margin-bottom-40">
                <div class="col-lg-3">
                    <div class="portlet light about-text" style="height: auto;padding-bottom: 15px !important;">
                        <h4 style="background-color:#36C6D3;font-size:18px">
                            <i class="fa fa-check icon-info"></i> About Organization</h4>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase"><i class="fa fa-pie-chart" aria-hidden="true"></i>&nbsp;General indicator by sector</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="easy-pie-chart">
                                                <div class="number bounce" data-percent="30">
                                                    <span>-30</span>% <canvas height="75" width="75"></canvas></div>

                                            </div>
                                        </div><div class="margin-bottom-10 visible-sm"> </div>
                                        <div class="col-md-2">
                                            <div class="easy-pie-chart">
                                                <div class="number visits" data-percent="60">
                                                    <span>60</span>% <canvas height="75" width="75"></canvas></div>

                                            </div>
                                        </div><div class="margin-bottom-10 visible-sm"> </div>
                                        <div class="col-md-2">
                                            <div class="easy-pie-chart">
                                                <div class="number transactions" data-percent="90">
                                                    <span>90</span>% <canvas height="75" width="75"></canvas></div>
                        ...
                        <div class="col-lg-6">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-bar-chart font-dark hide"></i>
                                        <span class="caption-subject font-red bold uppercase"><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;General statistic about gaza population</span>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="portlet light tasks-widget bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-bar-chart font-dark hide"></i>
                                        <span class="caption-subject font-red bold uppercase"> <i class="fa fa-check icon-info" aria-hidden="true"></i>&nbsp;About Survey </span>

                                    </div>
                                    <div class="pull-right" style="color:#838FA1">12/12/2015 - 12/12/2018 <i class="fa fa-calendar" aria-hidden="true"></i></div>
                                    <div class="pull-right" style="color:#838FA1">target name <i class="fa fa-dot-circle-o" aria-hidden="true"></i></div>
                                        ...
                                        <div class="scroller" style="height: 312px;" data-always-visible="1" data-rail-visible1="1">
                                            ...
                                            <ul class="task-list">
                                                <li>
                                                    ...
                                                    <div class="task-title">
													    <span class="easy-pie-chart">
															<div class="number transactions" data-percent="55" style="display:inline-block">
																<span>+55</span>% </div>															
														</span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="task-title">
													    <span class="easy-pie-chart">
															<div class="number bounce" data-percent="15" style="display:inline-block">
																<span>+15</span>% </div>															
														</span>
                                                        <span class="task-title-sp"> brief description of organization </span>
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="task-title">
													    <span class="easy-pie-chart">
															<div class="number visits" data-percent="85" style="display:inline-block">
																<span>+85</span>% </div>															
														</span>
                                                        <span class="task-title-sp"> brief description of organization </span>
                                                    </div>
